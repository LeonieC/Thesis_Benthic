### Bayesian Model -- Black Coral & Gorgonian Coral Cover with Light Attenuation ####
...
# Bayesian modelling ####
Binomial_BG.CoverLightA_model <- brm(Coral_points | trials(Tot_Points) ~  Light.Attenuation + (1 | Site),
                               data = BG_cover2, family = binomial(),  # prior = my_priors,
